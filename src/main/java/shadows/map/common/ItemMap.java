...
public class ItemMap extends Item{
	...
	private boolean hasUnmappedStructureNearby(String structure, World world, ItemStack stack, EntityPlayer player){
		...
		else if(this.isMapped(pos, world, player)) player.sendMessage(new TextComponentString("You have already mapped the nearest " + structure + "!"));
	...
	private String nameToStructureName(String displayname){
		...
		switch(fixedName){
		case("temple"): structure = "Temple"; break;
		case("mineshaft"): structure = "Mineshaft"; break;
		case("village"): structure = "Village"; break;
		case("monument"): structure = "Monument"; break;
		case("mansion"): structure = "Mansion"; break;
		case("stronghold"): structure = "Stronghold"; break;
		case("endcity"): structure = "EndCity"; break;
		case("fortress"): structure = "Fortress"; break;
		case("netherfortress"): structure = "Fortress"; break;
		}
